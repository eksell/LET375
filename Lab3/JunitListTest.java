...
//	}
	...
	//         // addFirst  = :
	//         // addLast   = +
	//         // (forall s in cases)(toList(s)++(x:toList(s)) = toList(s+x)++toList(s))
	//         for ( String s : cases ) {
	//             ListNode l1 = Lists.toList(s);
	//             ListNode l2 = Lists.toList(s); 
	//             ListNode secondPart = Lists.addFirst(l2,'X');
	//             ListNode lhs = Lists.addAll(l1,secondPart);
	//             assertFalse(hasSharedNodes(lhs,secondPart));
	//             l1 = Lists.toList(s);
	//             l2 = Lists.toList(s);  
	//             ListNode firstPart = Lists.addLast(l1,'X');
	//             ListNode rhs = Lists.addAll(firstPart,l2);
	//             assertFalse(hasSharedNodes(rhs,l2));
	//             assertTrue(Lists.equals(lhs,rhs));
	//          }
	//     }
	...
	public void testReverse()
	{
		...
		for ( String s : cases ) {
			...
			assertTrue(Lists.equals(lhs,Lists.addLast(l2,'Z')));
		}
	}
